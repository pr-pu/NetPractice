...
2. 클라이언트A - 클라이언트B - 클라이언트C
    ...
    - 어떤 서브넷 마스크를 쓰더라도, 이 세 기기의 IP는 인터페이스R2와 R3와 다른 네트워크에 있도록 해야 한다.
     ...
     - 이미 사용중인 대역인 0 ~ 127, 192 ~ 255를 피해서 인터페이스R1, A1, B1의 IP와 마스크를 입력하면 된다.
        ...
        -  마스크 `\26`: 이 경우, 서브넷 대역을 4개로 나눌 수 있다. 인터페이스A1의 IP 마지막 옥텟은 132로, 이는 서브넷3에 속한다. 따라서, 인터페이스B1과 R1은 129 ~ 190 사이에서 132를 제외한 숫자를 넣어주면 된다.
        -  마스크 `\27`: 이 경우, 서브넷 대역을 아래 표와 같이 8개로 나눌 수 있다. 인터페이스A1의 IP 마지막 옥텟은 132로, 이는 서브넷5에 속한다. 따라서, 인터페이스B1과 R1은 129 ~ 158 사이에서 132를 제외한 숫자를 넣어주면 된다.
        ...
        - 마스크 `\28`: 이 경우, 서브넷 대역을 아래 표와 같이 16개로 나눌 수 있다. 인터페이스A1의 IP 마지막 옥텟은 132로, 이는 서브넷9에 속한다. 따라서, 인터페이스B1과 R1은 129 ~ 142 사이에서 132를 제외한 숫자를 넣어주면 된다.
             
             | 서브넷 번호 | 추가된 비트의 조합 | 대역 시작 | 대역 끝 | 가능한 호스트 대역 |
             |:---:|:---:|:---:|:---:|:---:|  
             | 서브넷1 | 0000 | 0 | 15 | 1 ~ 14 |
             | 서브넷2 | 0001 | 16 | 31 | 17 ~ 30 |
             | 서브넷3 | 0010 | 32 | 47 | 33 ~ 46 |
             | 서브넷4 | 0011 | 48 | 63 | 49 ~ 62 |
             | 서브넷5 | 0100 | 64 | 79 | 65 ~ 78 |
             | 서브넷6 | 0101 | 80 | 95 | 81 ~ 94 |
             | 서브넷7 | 0110 | 96 | 111 | 97 ~ 110 |
             | 서브넷8 | 0111 | 112 | 127 | 113 ~ 126 |
             | 서브넷9 | 1000 | 128 | 143 | 129 ~ 142 |
             | 서브넷10 | 1001 | 144 | 159 | 143 ~ 158 |
             | 서브넷11 | 1010 | 160 | 175 | 161 ~ 174 |
             | 서브넷12 | 1011 | 176 | 191 | 177 ~ 190 |
             | 서브넷13 | 1100 | 192 | 207 | 193 ~ 206 |
             | 서브넷14 | 1101 | 208 | 223 | 209 ~ 222 |
             | 서브넷15 | 1110 | 224 | 249 | 225 ~ 248 |
             | 서브넷16 | 1111 | 240 | 255 | 241 ~ 254 |
        
        - 마스크 `\29`: 이 경우, 서브넷 대역을 32개로 나눌 수 있다. 인터페이스A1의 IP 마지막 옥텟은 132인데, 132는 대역이 `1000 0100'이므로, 비트의 조합이 10000인 경우이다. 다음 서브넷은 10001인 136(128 + 8)부터 시작할 것이다. 이 서브넷의 범위는 128부터 135 까지이다. 따라서, 인터페이스B1과 R1은 129 ~ 134 사이에서 132를 제외한 숫자를 넣어주면 된다.
